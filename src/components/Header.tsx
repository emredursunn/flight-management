...
const Header = ({addFlight}:Props) => {
  return (
    <View style={{width:393, height:'auto',flexDirection:'row', justifyContent:'space-between', top:59, paddingTop:3, paddingHorizontal:16, paddingBottom:8}}>
      ...
      <TouchableOpacity onPress={addFlight} style={{width:24,height:24, alignSelf:'center'}}>
        ...
        <Image source={require('../../assets/vertical_line.png')} style={{position:'absolute',height:14,top:5,left:12,borderWidth:2, borderColor:COLORS.gray[900]}}/>
      </TouchableOpacity>
    </View>
  )
}
